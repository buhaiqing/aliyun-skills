...
|--------------|------------------------|---------------------------|
| ECI vCPU quota | `alicloud-ask-ops` | [`alicloud-eci-ops`](../../alicloud-eci-ops/SKILL.md) |
| ECI memory quota | `alicloud-ask-ops` | [`alicloud-eci-ops`](../../alicloud-eci-ops/SKILL.md) |
| ECI instance count quota | `alicloud-ask-ops` | [`alicloud-eci-ops`](../../alicloud-eci-ops/SKILL.md) |
| Cluster CPU/Memory | `alicloud-ask-ops` | — |
| Pod Status (Pending) | `alicloud-ask-ops` | `alicloud-eci-ops` (quota) |
| API Server Latency | `alicloud-ask-ops` | (Alibaba-managed) |
...
[CMS Alarm Fires]
    ...
    ├── 2. Invoke alicloud-ask-ops to check cluster state + ECI quota
