# Runtime Harness Integration for alicloud-eci-ops
...
### Direct Command
```bash
aliyun eci DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/eci-harness-wrapper.sh DescribeContainerGroups --RegionId cn-hangzhou

# Check local trace
ls -lt .runtime/traces/alicloud-eci-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-eci-ops
```
