# Runtime Harness Integration for alicloud-eip-ops
...
3. **Resource Not Found** (`AllocationIdNotFound`) — verifies resource existence
...
./scripts/eip-harness-wrapper.sh DescribeEipAddresses --RegionId cn-hangzhou

# Check local trace
ls -lt .runtime/traces/alicloud-eip-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-eip-ops
```
