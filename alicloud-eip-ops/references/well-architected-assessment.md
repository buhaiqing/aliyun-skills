# Well-Architected Assessment — Alibaba Cloud EIP

This document evaluates the EIP skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:eip:*:*:eipaddress/*`. Avoid wildcard `*` actions. |
...
|-------------|---------------|---------|
| Pay-By-Traffic | Use Case | Savings |
...
|--------|-----------|---------------------|
| Bandwidth | acs_alicloud_eip | Threshold |
| TrafficIn/Out | acs_alicloud_eip | Threshold |
| ConnectionCount | acs_alicloud_eip | Threshold |
