# Well-Architected Assessment — Alibaba Cloud CloudMonitor

This document evaluates the CloudMonitor skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:cloudmonitor:*:*:alarm/metric/dashboard/*`. Avoid wildcard `*` actions. |
...
|-------------|---------------|---------|
| Free Tier | Use Case | Savings |
| Pay-As-You-Go (API Calls) | Use Case | Savings |
...
|--------|-----------|---------------------|
| API Calls | acs_alicloud_cms | Threshold |
| Custom Metrics | acs_alicloud_cms | Threshold |
| Alarm Notifications | acs_alicloud_cms | Threshold |
