...
| 1.5.1 | 2026-06-20 | **TE-6 dedup**: removed §3–§4 HITL Scoring/Workflow (duplicate of prompt-templates.md); replaced with reference link. ~1,000 tokens saved. |
