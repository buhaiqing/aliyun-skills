# Well-Architected Assessment — Alibaba Cloud SLB

This document evaluates the SLB skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:slb:*:*:loadbalancer/*`. Avoid wildcard `*` actions. |
...
|-------------|---------------|---------|
| Pay-As-You-Go (LCU) | Use Case | Savings |
| Pay-By-Bandwidth | Use Case | Savings |
...
|--------|-----------|---------------------|
| QPS | acs_alicloud_slb | Threshold |
| ActiveConnections | acs_alicloud_slb | Threshold |
| ResponseTime | acs_alicloud_slb | Threshold |
| DropConnections | acs_alicloud_slb | Threshold |
