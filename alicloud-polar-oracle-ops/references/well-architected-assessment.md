# Well-Architected Assessment — Alibaba Cloud PolarDB Oracle

This document evaluates the PolarDB Oracle skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:polardb oracle:*:*:dbcluster/*`. Avoid wildcard `*` actions. |
...
|--------|-----------|---------------------|
| CPUUtilization | acs_alicloud_polar_oracle | Threshold |
| MemoryUsage | acs_alicloud_polar_oracle | Threshold |
| Connections | acs_alicloud_polar_oracle | Threshold |
| QPS/TPS | acs_alicloud_polar_oracle | Threshold |
