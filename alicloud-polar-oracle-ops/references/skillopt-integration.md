# Runtime Harness Integration for alicloud-polar-oracle-ops
...
# Check local trace
ls -lt .runtime/traces/alicloud-polar-oracle-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-polar-oracle-ops
```
