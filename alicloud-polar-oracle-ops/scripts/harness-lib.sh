#!/bin/bash
# SkillOpt Core Library for alicloud-polar-oracle-ops
# Self-repair and dynamic optimization for PolarDB Oracle CLI commands.
...
SKILLOPT_LOG_LABEL="PolarDB-Oracle-SkillOpt"
SKILLOPT_SKILL_TAG="alicloud-polar-oracle-ops"
...
SKILLOPT_LOG_FILE="${ALIBABA_CLOUD_LOG_DIR:-${_SKILLOPT_LOGS_DIR:-$_SKILLOPT_RUNTIME_ROOT}}/polar-oracle-skillopt-$(date +%Y%m%d).log"
SKILLOPT_RUNTIME_DATA="${_SKILLOPT_METRICS_DATA_DIR:-$_SKILLOPT_RUNTIME_ROOT}/polar-oracle-skillopt-runtime.json"
# --- End shared core ---
