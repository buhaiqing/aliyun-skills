...
|----------|----------|------------|----------|
| DAS 实例未找到 | alicloud-das-ops | alicloud-rds-ops / alicloud-polar-mysql-ops / alicloud-polar-postgresql-ops / alicloud-polar-oracle-ops | instance_id, engine |
| 连通性诊断失败 | alicloud-das-ops | alicloud-vpc-ops | instance_id, src_ip, failure_reason |
| 实例状态异常 | alicloud-das-ops | alicloud-rds-ops / alicloud-polar-mysql-ops / alicloud-polar-postgresql-ops / alicloud-polar-oracle-ops | instance_id, status, engine |
