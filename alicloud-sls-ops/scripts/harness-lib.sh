#!/bin/bash
# SkillOpt Core Library for alicloud-sls-ops
# Self-repair and dynamic optimization for Log Service operations.
...
SKILLOPT_LOG_LABEL="SLS-SkillOpt"
SKILLOPT_SKILL_TAG="alicloud-sls-ops"
...
SKILLOPT_LOG_FILE="${ALIBABA_CLOUD_LOG_DIR:-${_SKILLOPT_LOGS_DIR:-$_SKILLOPT_RUNTIME_ROOT}}/sls-skillopt-$(date +%Y%m%d).log"
SKILLOPT_RUNTIME_DATA="${_SKILLOPT_METRICS_DATA_DIR:-$_SKILLOPT_RUNTIME_ROOT}/sls-skillopt-runtime.json"
# --- End shared core ---
