...
1. [核心设计原则](#1-核心设计原则)
   - [自愈能力成熟度模型](#11-自愈能力成熟度模型)
   - [自愈决策树原则](#12-自愈决策树原则)
2. [错误分类体系](#2-错误分类体系)
   - [CLI安装错误分类](#21-cli安装错误分类)
   - [Go Runtime JIT下载错误分类](#22-go-runtime-jit下载错误分类)
   - [依赖下载错误分类](#23-依赖下载错误分类)
3. [增强的自愈流程](#3-增强的自愈流程)
   - [CLI安装增强自愈流程](#31-cli安装增强自愈流程)
   - [Go Runtime JIT下载增强自愈流程](#32-go-runtime-jit下载增强自愈流程)
4. [降级路径和用户指导](#4-降级路径和用户指导)
   - [降级路径决策树](#41-降级路径决策树)
   - [用户指导模板](#42-用户指导模板)
5. [健康检查和状态验证](#5-健康检查和状态验证)
   - [安装后健康检查](#51-安装后健康检查)
   - [Go Runtime健康检查](#52-go-runtime健康检查)
