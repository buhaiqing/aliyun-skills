# Runtime Harness Integration for alicloud-dts-ops
...
### Direct Command
```bash
aliyun dts DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/dts-harness-wrapper.sh DescribeDtsJobs --RegionId cn-hangzhou

# Check local trace
ls -lt .runtime/traces/alicloud-dts-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-dts-ops
```
