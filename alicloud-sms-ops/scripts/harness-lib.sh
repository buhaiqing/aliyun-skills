#!/bin/bash
# SkillOpt Core Library for alicloud-sms-ops
# Self-repair and dynamic optimization for SMS (dysmsapi) CLI commands.
...
SKILLOPT_LOG_LABEL="SMS-SkillOpt"
SKILLOPT_SKILL_TAG="alicloud-sms-ops"
...
SKILLOPT_LOG_FILE="${ALIBABA_CLOUD_LOG_DIR:-${_SKILLOPT_LOGS_DIR:-$_SKILLOPT_RUNTIME_ROOT}}/sms-skillopt-$(date +%Y%m%d).log"
SKILLOPT_RUNTIME_DATA="${_SKILLOPT_METRICS_DATA_DIR:-$_SKILLOPT_RUNTIME_ROOT}/sms-skillopt-runtime.json"
# --- End shared core ---
