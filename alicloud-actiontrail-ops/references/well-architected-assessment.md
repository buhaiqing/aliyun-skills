# Well-Architected Assessment — Alibaba Cloud ActionTrail

This document evaluates the ActionTrail skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:actiontrail:*:*:trail/event/*`. Avoid wildcard `*` actions. |
...
|-------------|---------------|---------|
| Free | Use Case | Savings |
| Pay-As-You-Go (OSS/SLS Storage) | Use Case | Savings |
...
|--------|-----------|---------------------|
| EventCount | acs_alicloud_actiontrail | Threshold |
| StorageSize | acs_alicloud_actiontrail | Threshold |
| QueryLatency | acs_alicloud_actiontrail | Threshold |
