...
Phase 2 (2026-06-21) for destructive trail ops and structure validation.
...
| Version | Date | Change |
|---------|------|--------|
| 1.1.0 | 2026-06-21 | Phase 2: added `references/rubric.md` + `references/prompt-templates.md`; SKILL.md `## Quality Gate (GCL)` |
