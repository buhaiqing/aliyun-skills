...
# 导入测试目标
from resource_registry import CapabilityChecker, ResourceRegistry, SupportLevel
...
def run_all_tests():
    ...
    print(f"\n{'='*60}")
    print("PreFlight Integration Test Suite")
    print(f"{'='*60}")
