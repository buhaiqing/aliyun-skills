...
output "mongodb_instance_id" {
  value = var.enable_mongodb ? module.mongodb[0].mongodb_instance_id : null
}
...
output "polardb_cluster_id" {
  value = var.enable_polardb ? module.polardb[0].polardb_cluster_id : null
}

output "polardb_connection_string" {
  value = var.enable_polardb ? module.polardb[0].polardb_connection_string : null
}

output "alb_id" {
  value = var.enable_alb ? module.alb[0].alb_id : null
}
