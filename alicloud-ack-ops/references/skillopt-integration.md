# Runtime Harness Integration for alicloud-ack-ops
...
### Direct Command
```bash
aliyun ack DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/ack-harness-wrapper.sh GET /clusters

# Check local trace
ls -lt .runtime/traces/alicloud-ack-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-ack-ops
```
