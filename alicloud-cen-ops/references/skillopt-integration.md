# Runtime Harness Integration for alicloud-cen-ops
...
6. **Quota Exceeded** (`CenInstanceLimit`) — notifies user of limits

## Usage

### Direct Command
```bash
aliyun cbn DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/cen-harness-wrapper.sh DescribeCens

# Check local trace
ls -lt .runtime/traces/alicloud-cen-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-cen-ops
```
