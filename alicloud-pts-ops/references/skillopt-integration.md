# Runtime Harness Integration for alicloud-pts-ops
...
### Direct Command
```bash
aliyun pts DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
# Check local trace
ls -lt .runtime/traces/alicloud-pts-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-pts-ops
```
