#!/bin/bash
# SkillOpt Core Library for alicloud-polar-mysql-ops
# Self-repair and dynamic optimization for PolarDB MySQL operations.
...
SKILLOPT_LOG_LABEL="PolarDB-MySQL-SkillOpt"
SKILLOPT_SKILL_TAG="alicloud-polar-mysql-ops"
...
SKILLOPT_LOG_FILE="${ALIBABA_CLOUD_LOG_DIR:-${_SKILLOPT_LOGS_DIR:-$_SKILLOPT_RUNTIME_ROOT}}/polar-mysql-skillopt-$(date +%Y%m%d).log"
SKILLOPT_RUNTIME_DATA="${_SKILLOPT_METRICS_DATA_DIR:-$_SKILLOPT_RUNTIME_ROOT}/polar-mysql-skillopt-runtime.json"
# --- End shared core ---
