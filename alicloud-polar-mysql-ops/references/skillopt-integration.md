# Runtime Harness Integration for alicloud-polar-mysql-ops
...
./scripts/polar-mysql-harness-wrapper.sh DescribeDBClusters --RegionId cn-hangzhou

# Check local trace
ls -lt .runtime/traces/alicloud-polar-mysql-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-polar-mysql-ops
```
