# Runtime Harness Integration for alicloud-resourcemanager-ops
...
### Direct Command
```bash
aliyun resourcemanager DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/resourcemanager-harness-wrapper.sh ListAccounts

# Check local trace
ls -lt .runtime/traces/alicloud-resourcemanager-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-resourcemanager-ops
```
