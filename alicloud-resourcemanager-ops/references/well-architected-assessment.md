# Well-Architected Assessment — Alibaba Cloud Resource Manager

This document evaluates the Resource Manager skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:resource manager:*:*:folder/account/resourcegroup/*`. Avoid wildcard `*` actions. |
...
- Resource Hierarchy Export
- Control Policy Backup
...
|--------|-----------|---------------------|
| ResourceCount | acs_alicloud_resourcemanager | Threshold |
| AccountCount | acs_alicloud_resourcemanager | Threshold |
| PolicyAttachments | acs_alicloud_resourcemanager | Threshold |
