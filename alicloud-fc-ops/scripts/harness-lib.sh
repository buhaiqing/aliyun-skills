#!/bin/bash
# SkillOpt Core Library for alicloud-fc-ops
# Self-repair and dynamic optimization for Function Compute operations.
...
SKILLOPT_LOG_LABEL="FC-SkillOpt"
SKILLOPT_SKILL_TAG="alicloud-fc-ops"
...
SKILLOPT_LOG_FILE="${ALIBABA_CLOUD_LOG_DIR:-${_SKILLOPT_LOGS_DIR:-$_SKILLOPT_RUNTIME_ROOT}}/fc-skillopt-$(date +%Y%m%d).log"
SKILLOPT_RUNTIME_DATA="${_SKILLOPT_METRICS_DATA_DIR:-$_SKILLOPT_RUNTIME_ROOT}/fc-skillopt-runtime.json"
# --- End shared core ---
