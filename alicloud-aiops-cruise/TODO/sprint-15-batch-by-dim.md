...
### ✅ T1: _shared.py 新增 `q_cms_batch_by_dim()` helper
...
### ✅ T2: daily-health-check `_collect_one` 重构
...
### ✅ T3: capacity-planning `finops_check` 重构
...
- [x] F2: OpenAPI accuracy — ✅ CMS DescribeMetricList 文档支持 Dimensions 数组多组
- [x] F3: Error handling — ✅ q_cms_batch_by_dim 内部 try/except, 失败 dim_value 返回 []
