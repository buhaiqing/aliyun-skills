...
AIOPS_DIR="$(cd "${SCRIPT_DIR}/../../../../runbooks/scripts" && pwd)"
AUDIT_DIR="$(cd "${SCRIPT_DIR}/../../../../audit-results" && pwd)"
OUTPUT_FILE=""
...
python3 "${AIOPS_DIR}/daily-health-check.py" \
    --customer "${CUSTOMER}" \
