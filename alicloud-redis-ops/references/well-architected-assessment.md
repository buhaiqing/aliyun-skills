# Well-Architected Assessment — Alibaba Cloud Redis

This document evaluates the Redis skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:redis:*:*:instance/*`. Avoid wildcard `*` actions. |
...
|--------|-----------|---------------------|
| CPUUtilization | acs_alicloud_redis | Threshold |
| MemoryUsage | acs_alicloud_redis | Threshold |
| Connections | acs_alicloud_redis | Threshold |
| OpsPerSec | acs_alicloud_redis | Threshold |
