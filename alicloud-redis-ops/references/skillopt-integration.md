# Runtime Harness Integration for alicloud-redis-ops
...
### Direct Command
```bash
aliyun redis DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
# Check local trace
ls -lt .runtime/traces/alicloud-redis-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-redis-ops
```
