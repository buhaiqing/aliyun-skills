# Runtime Harness Integration for alicloud-voice-ops
...
### Direct Command
```bash
aliyun dyvmsapi DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/voice-harness-wrapper.sh QueryCallStatistics

# Check local trace
ls -lt .runtime/traces/alicloud-voice-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-voice-ops
```
