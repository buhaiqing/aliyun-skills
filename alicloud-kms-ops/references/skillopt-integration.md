# Runtime Harness Integration for alicloud-kms-ops
...
### Direct Command
```bash
aliyun kms DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/kms-harness-wrapper.sh ListKeys --RegionId cn-hangzhou

# Check local trace
ls -lt .runtime/traces/alicloud-kms-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-kms-ops
```
