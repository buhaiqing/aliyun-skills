...
> **EXECUTION MANDATORY RULE**: 所有 control-plane CLI 执行步骤 **必须** 通过 SkillOpt wrapper `./scripts/kms-skillopt-wrapper.sh` 运行。
...
- [Polling Patterns](references/polling-patterns.md) — KMS key 状态轮询模板
