# Runtime Harness Integration for alicloud-ram-ops
...
### Direct Command
```bash
aliyun ram DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/ram-harness-wrapper.sh ListUsers

# Check local trace
ls -lt .runtime/traces/alicloud-ram-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-ram-ops
```
