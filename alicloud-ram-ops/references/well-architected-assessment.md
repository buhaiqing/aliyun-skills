# Well-Architected Assessment — Alibaba Cloud RAM

This document evaluates the RAM skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:ram:*:*:user/role/policy/*`. Avoid wildcard `*` actions. |
...
|--------|-----------|---------------------|
| ActiveSessions | acs_alicloud_ram | Threshold |
| AccessKeyAge | acs_alicloud_ram | Threshold |
| PolicyAttachments | acs_alicloud_ram | Threshold |
