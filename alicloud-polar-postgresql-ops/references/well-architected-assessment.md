# Well-Architected Assessment — Alibaba Cloud PolarDB PostgreSQL

This document evaluates the PolarDB PostgreSQL skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:polardb postgresql:*:*:dbcluster/*`. Avoid wildcard `*` actions. |
...
|--------|-----------|---------------------|
| CPUUtilization | acs_alicloud_polar_postgresql | Threshold |
| MemoryUsage | acs_alicloud_polar_postgresql | Threshold |
| Connections | acs_alicloud_polar_postgresql | Threshold |
| QPS/TPS | acs_alicloud_polar_postgresql | Threshold |
