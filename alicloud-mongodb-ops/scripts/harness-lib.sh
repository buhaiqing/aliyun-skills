#!/bin/bash
# SkillOpt Core Library for alicloud-mongodb-ops
# Self-repair and dynamic optimization for MongoDB (DDS) CLI commands.
...
SKILLOPT_LOG_LABEL="MongoDB-SkillOpt"
SKILLOPT_SKILL_TAG="alicloud-mongodb-ops"
...
SKILLOPT_LOG_FILE="${ALIBABA_CLOUD_LOG_DIR:-${_SKILLOPT_LOGS_DIR:-$_SKILLOPT_RUNTIME_ROOT}}/mongodb-skillopt-$(date +%Y%m%d).log"
SKILLOPT_RUNTIME_DATA="${_SKILLOPT_METRICS_DATA_DIR:-$_SKILLOPT_RUNTIME_ROOT}/mongodb-skillopt-runtime.json"
# --- End shared core ---
