# Runtime Harness Integration for alicloud-mongodb-ops
...
### Direct Command
```bash
aliyun mongodb DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/mongodb-harness-wrapper.sh DescribeDBInstances --RegionId cn-hangzhou

# Check local trace
ls -lt .runtime/traces/alicloud-mongodb-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-mongodb-ops
```
