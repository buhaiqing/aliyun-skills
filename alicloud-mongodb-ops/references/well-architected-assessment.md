# Well-Architected Assessment — Alibaba Cloud MongoDB

This document evaluates the MongoDB skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:mongodb:*:*:dbinstance/*`. Avoid wildcard `*` actions. |
...
|--------|-----------|---------------------|
| CPUUtilization | acs_alicloud_mongodb | Threshold |
| MemoryUsage | acs_alicloud_mongodb | Threshold |
| Connections | acs_alicloud_mongodb | Threshold |
| QPS | acs_alicloud_mongodb | Threshold |
