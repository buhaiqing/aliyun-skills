# Well-Architected Assessment — Alibaba Cloud NAT Gateway

This document evaluates the NAT Gateway skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:nat gateway:*:*:natgateway/*`. Avoid wildcard `*` actions. |
...
|--------|-----------|---------------------|
| SNAT Connections | acs_alicloud_nat | Threshold |
| DNAT Rules | acs_alicloud_nat | Threshold |
| Bandwidth | acs_alicloud_nat | Threshold |
