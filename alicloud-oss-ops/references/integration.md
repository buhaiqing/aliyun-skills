...
Existing shell exports are never overwritten. See [SkillOpt Integration — Environment Variable Loading](skillopt-integration.md#environment-variable-loading).
