# Well-Architected Assessment — Alibaba Cloud DAS

This document evaluates the DAS skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:das:*:*:instance/alarm/*`. Avoid wildcard `*` actions. |
...
|--------|-----------|---------------------|
| Active Sessions | acs_alicloud_das | Threshold |
| Slow Queries | acs_alicloud_das | Threshold |
| Storage | acs_alicloud_das | Threshold |
