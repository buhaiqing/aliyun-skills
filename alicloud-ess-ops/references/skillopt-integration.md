# Runtime Harness Integration for alicloud-ess-ops
...
### Direct Command
```bash
aliyun ess DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/ess-harness-wrapper.sh DescribeScalingGroups --RegionId cn-hangzhou

# Check local trace
ls -lt .runtime/traces/alicloud-ess-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-ess-ops
```
