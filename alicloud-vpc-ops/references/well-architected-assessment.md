# Well-Architected Assessment — Alibaba Cloud VPC

This document evaluates the VPC skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:vpc:*:*:vpc/vswitch/routetable/*`. Avoid wildcard `*` actions. |
...
| Pay-As-You-Go (NAT/SLB/EIP) | Use Case | Savings |
...
|--------|-----------|---------------------|
| NetworkIn/Out | acs_alicloud_vpc | Threshold |
| ConnectionCount | acs_alicloud_vpc | Threshold |
| BandwidthUtilization | acs_alicloud_vpc | Threshold |
