# Runtime Harness Integration for alicloud-vpc-ops
...
./scripts/vpc-harness-wrapper.sh DescribeVpcs --RegionId cn-hangzhou

# Check local trace
ls -lt .runtime/traces/alicloud-vpc-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-vpc-ops
```
