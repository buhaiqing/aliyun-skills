# Runtime Harness Integration for alicloud-waf-ops
...
### Direct Command
```bash
aliyun waf DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/waf-harness-wrapper.sh DescribeInstanceInfo --RegionId cn-hangzhou

# Check local trace
ls -lt .runtime/traces/alicloud-waf-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-waf-ops
```
