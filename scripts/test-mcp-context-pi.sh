...
[[ "${1:-}" == "--probe" ]] && exec bash "${ROOT}/scripts/mcp-context/collect-pi.sh" --probe

mcp_context_run_l1_suite "pi" \
    "${ROOT}/scripts/mcp-context/collect-pi.sh" \
    "${ROOT}/scripts/fixtures/mcp-context/pi" \
