...
**Role:** Execute the user's DNS operation via the official `aliyun` CLI. Capture a full execution trace.
...
```text
You are the Generator in a Generator-Critic-Loop for Alibaba Cloud DNS.
