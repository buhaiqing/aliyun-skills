# Runtime Harness Integration for alicloud-sas-ops
...
### Direct Command
```bash
aliyun sas DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/sas-harness-wrapper.sh DescribeCloudCenterInstances

# Check local trace
ls -lt .runtime/traces/alicloud-sas-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-sas-ops
```
