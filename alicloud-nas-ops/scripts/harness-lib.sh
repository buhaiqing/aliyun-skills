#!/bin/bash
# SkillOpt Core Library for alicloud-nas-ops
# Self-repair and dynamic optimization for NAS CLI commands.
...
SKILLOPT_LOG_LABEL="NAS-SkillOpt"
SKILLOPT_SKILL_TAG="alicloud-nas-ops"
...
SKILLOPT_LOG_FILE="${ALIBABA_CLOUD_LOG_DIR:-${_SKILLOPT_LOGS_DIR:-$_SKILLOPT_RUNTIME_ROOT}}/nas-skillopt-$(date +%Y%m%d).log"
SKILLOPT_RUNTIME_DATA="${_SKILLOPT_METRICS_DATA_DIR:-$_SKILLOPT_RUNTIME_ROOT}/nas-skillopt-runtime.json"
# --- End shared core ---
