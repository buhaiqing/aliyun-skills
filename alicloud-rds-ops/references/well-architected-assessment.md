# Well-Architected Assessment — Alibaba Cloud RDS

This document evaluates the RDS skill's operations against Alibaba Cloud's
...
|-------------|----------|
| **RAM Policy** | Use scoped permissions: `acs:rds:*:*:dbinstance/*`. Avoid wildcard `*` actions. |
...
|--------|-----------|---------------------|
| CPUUtilization | acs_alicloud_rds | Threshold |
| MemoryUsage | acs_alicloud_rds | Threshold |
| Connections | acs_alicloud_rds | Threshold |
| IOPS | acs_alicloud_rds | Threshold |
