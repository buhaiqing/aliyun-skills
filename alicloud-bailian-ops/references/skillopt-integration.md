# Runtime Harness Integration for alicloud-bailian-ops
...
### Direct Command
```bash
aliyun bailian DescribeInstances --skillopt-enable --RegionId cn-hangzhou
```
...
./scripts/bailian-harness-wrapper.sh ListModels

# Check local trace
ls -lt .runtime/traces/alicloud-bailian-ops/ | head -3

# Verify in Langfuse UI
# Navigate to https://hai-langfuse-int.hd123.com → Sessions → skill:alicloud-bailian-ops
```
